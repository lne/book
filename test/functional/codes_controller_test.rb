...
class CodesControllerTest < ActionController::TestCase
  ...
  test "should create code" do
    assert_difference('Code.count') do
      post :create, code: { chapter: @code.chapter, number: @code.number, product_id: @code.product_id, section: @code.section, source: @code.source }
    end
  ...
  test "should update code" do
    put :update, id: @code, code: { chapter: @code.chapter, number: @code.number, product_id: @code.product_id, section: @code.section, source: @code.source }
    assert_redirected_to code_path(assigns(:code))
  end
